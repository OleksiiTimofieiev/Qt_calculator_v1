    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->pushButton_signedness, SIGNAL(clicked()), this, SLOT(operations()));
...
void    MainWindow::digits_numbers(void)
{
...
void    MainWindow::operations(void)
{
    QPushButton *button = (QPushButton *)sender();
    double   all_numbers;
    QString  new_label;
...
void MainWindow::math_operations(void)
{
    QPushButton *button = (QPushButton *)sender();
